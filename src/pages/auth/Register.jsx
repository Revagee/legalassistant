        ...
        <div className="mx-auto max-w-md px-6 py-8">
            ...
            <form onSubmit={onSubmit} className="mt-6 grid gap-4" autoComplete="on">
                <label className="text-sm font-semibold text-gray-900">Ім'я
                    <input type="text" name="name" autoComplete="name" required disabled={loading} className="mt-1 w-full rounded-md border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[rgba(30,58,138,0.2)]" />
                </label>
                ...
                <label className="text-sm font-semibold text-gray-900">Пароль
                    <input type="password" name="password" autoComplete="new-password" required disabled={loading} className="mt-1 w-full rounded-md border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[rgba(30,58,138,0.2)]" />
                </label>
                <label className="text-sm font-semibold text-gray-900">Повторіть пароль
                    <input type="password" name="password2" autoComplete="new-password" required disabled={loading} className="mt-1 w-full rounded-md border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[rgba(30,58,138,0.2)]" />
                </label>
