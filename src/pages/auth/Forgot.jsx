    ...
    return (
        <div className="mx-auto max-w-md px-6 py-8">
            ...
            <form onSubmit={onSubmit} className="mt-6 grid gap-4">
                ...
                <button type="submit" disabled={loading} className="rounded-md bg-[#1E3A8A] px-4 py-2 text-sm font-medium text-white hover:opacity-95 disabled:opacity-70">{loading ? 'Надсилання…' : 'Надіслати інструкції'}</button>
            </form>
        </div>
    )
}
