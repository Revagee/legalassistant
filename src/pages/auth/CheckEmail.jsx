...
export default function CheckEmail() {
    ...
    return (
        <div className="mx-auto max-w-md px-6 py-8">
            <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight" style={{ color: '#1E3A8A' }}>Перевірте пошту</h1>
            ...
            <div className="mt-6 grid gap-3">
                <button onClick={goToLogin} className="rounded-md bg-[#1E3A8A] px-4 py-2 text-sm font-medium text-white hover:opacity-95">Повернутися до входу</button>
